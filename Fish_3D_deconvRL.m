...
% ========== 1. 配置路径和参数 ==========
% 读取光场重排后的图像文件
TargetFile = './LightField_Data/video/3D/Selected_Views_Combined.tif'; 
%TargetFile = './LightField_Data/video/Selected_Views.tif'; 
View_Num = 7; 
...
% ========== 5. 保存结果 ==========
reconPath = './LightField_Data/video/3D/';
if ~exist(reconPath, 'dir')
    mkdir(reconPath);
end
resultFile = fullfile(reconPath, 'Fish_3D_Reconstructed_Image_2.tif');
